...
% The training data
% XTrain = ...
%Bias must be the last feature, adds one column to xtrain with 1:s
XTrain(:,end+1) = 1;
...
W0 = randn(width(XTrain),width(DTrain));  %rader, columner
%Features x classification  
%Fill in the code that initialize the parameters in W. If you get stuck, think about how many neurons
%you need for the dataset and how many features there is.
